window.PORTFOLIO_CONTENT = {
  "seo": {
    ...
    "description": "Portfolio of Kevin Trayner: principal experience design leadership focused on strategy, systems, and measurable outcomes.",
  ...
  "workingStyle": {
    ...
    "profileSignals": [
      {
        ...
        "note": "Communication-forward, people-centered, and motivated by meaningful impact."
      },
      {
        "label": "Primary Strength Domain",
        "value": "Relationship Building",
        "note": "CliftonStrengths profile is led by relationship-building themes."
      }
    ],
    "topStrengths": [
      "Empathy",
    ...
    "pillars": [
      {
        "title": "Frame",
        "body": "I detect emotional and organizational signals early, then convert ambiguity into a decision-ready frame with clear goals, risks, and success criteria."
      },
      {
        "title": "Align",
        "body": "I build trust quickly across Product, Engineering, and business teams through clear communication, inclusive facilitation, and practical collaboration."
      },
      {
        "title": "Ship",
        "body": "I move from insight to shippable outcomes through prototyping, critique, and rationale grounded in user needs, technical constraints, and business context."
      },
      {
        "title": "Scale",
